...
export default async function Footer() {
  ...
  return (
    <footer className="bg-brand text-white px-6 pt-20 pb-8">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <Link
            href="/contact"
            className="border border-white/40 px-6 py-2 rounded-full text-sm 
            hover:bg-white hover:text-brand hover:shadow-lg hover:-translate-y-0.5 
